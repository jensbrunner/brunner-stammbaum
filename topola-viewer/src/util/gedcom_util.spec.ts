...
describe('Media Resolution and Utilities', () => {
  ...
  describe('resolveFileUrl()', () => {
    ...
    it('resolves relative paths against a hosted GEDCOM base URL', () => {
      expect(
        resolveFileUrl(
          'media/images/img.jpg',
          undefined,
          'https://example.com/stammbaum/',
        ),
      ).toBe('https://example.com/stammbaum/media/images/img.jpg');
      expect(
        resolveFileUrl(
          'media\\images\\img.jpg',
          undefined,
    ...
    it('does not turn Windows absolute paths into hosted URLs', () => {
      expect(
        resolveFileUrl(
          'C:\\Users\\jensb\\photo.jpg',
          undefined,
          'https://example.com/stammbaum/',
        ),
      ).toBe('C:/Users/jensb/photo.jpg');
    });
  });

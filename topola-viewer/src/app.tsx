...
import {EncryptedUnlockPage} from './pages/encrypted_unlock_page';
import {ViewPage} from './pages/view_page';
import {getEncryptedArchiveUrl, getStaticUrl} from './util/url_args';

const staticUrl = getStaticUrl();
const encryptedArchiveUrl = getEncryptedArchiveUrl();
...
export function App() {
  ...
  if (encryptedArchiveUrl) {
    return (
      <Routes>
        <Route
          path="/"
          element={<EncryptedUnlockPage archiveUrl={encryptedArchiveUrl} />}
        />

...
function toEvent(
  ...
  if (entry.tag === 'FAMS') {
    return toFamilyEvents(entry, gedcom, indi, images, mediaBaseUrl);
  }
  return toIndiEvent(entry, gedcom, indi, intl, images, mediaBaseUrl);
}
  ...
  return [
    {
      ...
      images: eventImages(entry, gedcom, images, mediaBaseUrl),
      files: eventFiles(entry, gedcom, images, mediaBaseUrl),
...
function toFamilyEvents(
  ...
  return flatMap(FAMILY_EVENT_TAGS, (tag) =>
    ...
    return {
      ...
      images: eventImages(familyEvent, gedcom, images, mediaBaseUrl),
      files: eventFiles(familyEvent, gedcom, images, mediaBaseUrl),
